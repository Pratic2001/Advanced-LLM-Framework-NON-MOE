...
const setupSteps = [
  ...
  {
    id: "deepspeed",
    title: "DeepSpeed Installation",
    icon: Waves,
    description: "Install DeepSpeed with CUDA kernel support.",
    commands: [
...
export default function DeepSpeedSetupPage() {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div>
        <h1 className="text-2xl font-bold">DeepSpeed Setup</h1>
        <p className="text-muted-foreground mt-1 text-sm">
          Prepare your environment for DeepSpeed distributed training with ZeRO optimization.
        </p>
      </div>
      ...
      {allDone && (
        <motion.div
          ...
          style={{ boxShadow: "0 0 20px rgba(0,136,255,0.1)" }}
        >
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Your DeepSpeed environment is ready. Next steps:
          </p>
          <div className="flex flex-wrap gap-3">
            <a
              href="/dashboard/deepspeed/nodes"
            ...
            <a
              href="/dashboard/deepspeed/config"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg glass text-sm font-medium hover:bg-accent/50 transition-all"
            >
